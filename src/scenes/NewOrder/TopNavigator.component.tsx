...
export const TopNavigationComponent = (props) => (
  <Layout level="4" style={{minHeight:122,justifyContent: 'center',padding:10}}>
    <Layout style={{ justifyContent: 'center',alignItems: 'center',marginBottom:5}} 
            level="4"
            >
      <Text category="h6" status={"success"}>NEW SERVICE ORDER </Text>
...
const Loading =()=>{
  return  <Layout style={{ flexDirection: 'row',justifyContent: 'center',}} level="4">
    <Spinner status='info'/>
    <Text category="h4">Refreshing ....</Text>
