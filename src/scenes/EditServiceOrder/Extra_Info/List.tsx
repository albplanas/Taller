...
export const CenterList = (props) => {
          ...
          var data= dataPicturesConstruction(props.route.params.item.IdMaintenance,props.SO_Picture_OffLine,props.PictureArrayOriginal)   
         
            return <Layout style={{height:450}}> 
                           
                            <Carouselexample 
                                                    imgList={data}  
                                                    onUpload_Picture={props.onUpdate_EDIT_SO}
                                                    vertical={true}
                                                    label="SO_Picture_OffLine"
                                                    Dimensions={{
                                                      itemWidth:650,
                                                      sliderWidth:800,
                                                      sliderHeight:300,
